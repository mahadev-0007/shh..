...
cp "$BIN" "$APP/Contents/MacOS/sshm"
...
if [ -n "$SPARKLE" ]; then
    ...
    install_name_tool -add_rpath "@executable_path/../Frameworks" \
        "$APP/Contents/MacOS/sshm" 2>/dev/null || true
fi
...
<plist version="1.0">
<dict>
  <key>CFBundleName</key>              <string>ArkConnect</string>
  <key>CFBundleDisplayName</key>       <string>ArkConnect</string>
  <key>CFBundleExecutable</key>        <string>sshm</string>
